...
public class WaveViewCopy extends View {
    ...
    public WaveViewCopy(Context context) {
        this(context, null);
    }

    public WaveViewCopy(Context context, AttributeSet attrs) {
        this(context, attrs, 0);


    }

    public WaveViewCopy(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        mWavePath.lineTo(-mViewWidth/mWaveLengthRatio, mViewHeight);
        mWavePath.close();
