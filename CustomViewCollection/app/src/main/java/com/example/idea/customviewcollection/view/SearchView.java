...
/**
 * Created by idea on 2017/1/3.
 * 扩展 @see <a href="https://github.com/android-cjj/JJSearchViewAnim">JJSearchViewAnim</a>
 * 参考文档 @see  <a href="https://github.com/GcsSloop/AndroidNote/blob/master/CustomView/Advance/%5B08%5DPath_Play.md">Path之玩出花样(PathMeasure)</a>
 */
...
//        canvas.scale(1,-1);                 // 翻转Y轴
        ...
        switch (mCurrentState) {
            ...
            case STARTING:
                ...
                Path dst = new Path();
                LogUtils.w(this, " mAnimatorValue=" + mAnimatorValue);


                mMeasure.getSegment(mMeasure.getLength() * mAnimatorValue, mMeasure.getLength(), dst, true);
                LogUtils.w(this, " mMeasure.getLength() * mAnimatorValue=" + mMeasure.getLength() * mAnimatorValue + " mMeasure.getLength()=" + mMeasure.getLength());
